...
// --- Hook Verification (polling, for onboarding) ---
      ...
      {verified ? (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 dark:text-gray-600 mt-0.5">Run a completion in your AI tool to verify</p>
          </div>
        </div>
      )}
    </div>
  ...
  return (
    <div className="text-center py-6">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 max-w-[280px] mx-auto leading-relaxed">
        Start using your AI coding tool and watch your activity appear on your profile.
      </p>
      <button
        onClick={onComplete}
